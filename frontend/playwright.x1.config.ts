...
import { journal } from './benchmarks/storage';
...
export default defineConfig({
  ...
  reporter: [['list'], ['./benchmarks/reporter.ts'], ['junit', { outputFile: resolve(journal, 'browser-junit.xml') }]],
  outputDir: resolve(journal, 'playwright'),
