...
[![tests](https://img.shields.io/badge/tests-456%20offline%2C%20no%20key%2C%20no%20network-22c55e)](#run-it)
...
| | |
|---|---|
| the ledger, six domains, P&L, cash, metrics | real, 456 tests, 93% branch coverage |
